...
mod tests {
    ...
    fn hash_deterministic() {
        let a = hash(0, b"hello");
        let b = hash(0, b"hello");
        assert_eq!(a, b);
    }
    ...
    fn hash_different_inputs() {
        let a = hash(0, b"hello");
        let b = hash(0, b"world");
        assert_ne!(a, b);
    }

    #[test]
    fn hash_str_consistent() {
        let a = hash_str(0, "hello");
        let b = hash(0, b"hello");
        assert_eq!(a, b);
    }

    #[test]
    fn hash_different_seeds() {
        let a = hash(0, b"hello");
        let b = hash(42, b"hello");
        assert_ne!(a, b);
    }

    #[test]
    fn wymix_basic() {
        let r = wymix(12345, 67890);
        // Should produce a non-trivial mix
        assert_ne!(r, 12345);
        assert_ne!(r, 67890);
    }
